...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=get_env_var("ACCESS_TOKEN_LIFETIME")["minutes"]),
    'REFRESH_TOKEN_LIFETIME': timedelta(minutes=get_env_var("REFRESH_TOKEN_LIFETIME")["minutes"]),
