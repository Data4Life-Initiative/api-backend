...
# Todo : Registration for citizen
# Todo : Remove is_profile_complete
# Todo : Mobile, Fullname, DOB is required
# Todo : Citizen location model required to stored the continous location updates
